...
Using data uploaded into R by the user, this replicates the functionality of the lm() call in R while allowing for specification of HC0 or HC1 std. error correction.
